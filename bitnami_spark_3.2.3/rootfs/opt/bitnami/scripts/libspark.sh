...
########################
# Configure Spark RPC Authentication (http://spark.apache.org/docs/latest/security.html#authentication)
# Globals:
#   SPARK_*
# Arguments:
#   None
...
########################
# Configure Spark RPC Encryption (http://spark.apache.org/docs/latest/security.html#encryption)
# Globals:
#   SPARK_*
# Arguments:
#   None
...
########################
# Configure Spark Local Storage Encryption (http://spark.apache.org/docs/latest/security.html#local-storage-encryption)
# Globals:
#   SPARK_*
# Arguments:
#   None
...
########################
# Configure Spark SSL (http://spark.apache.org/docs/latest/security.html#ssl-configuration)
# Globals:
#   SPARK_*
# Arguments:
#   None
